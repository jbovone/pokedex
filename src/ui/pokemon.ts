...
function mostrarTipos(tipos: Pokemon["tipos"]) {
...
function mostrarHabilidades(habilidades: Pokemon["habilidades"]) {
...
export default function mostrarPokemon(pokemon: Pokemon) {
  ...
  document.querySelector<HTMLDivElement>("#pokemon-contenedor")!.style.display =
    "block";
